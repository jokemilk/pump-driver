...
//#define PUMP_SET_PUSH_ACC _IOW(PUMP_IOC_MAGIC,  5, int)
//#define PUMP_SET_PUSH_AVG _IOW(PUMP_IOC_MAGIC,  6, int)
//#define PUMP_SET_PULL_ACC _IOW(PUMP_IOC_MAGIC,  7, int)
//#define PUMP_SET_PULL_AVG _IOW(PUMP_IOC_MAGIC,  8, int)
/*
